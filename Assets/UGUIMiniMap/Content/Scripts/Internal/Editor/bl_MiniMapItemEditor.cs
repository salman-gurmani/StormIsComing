...
public class bl_MiniMapItemEditor : Editor
{
    ...
    {
        bl_MiniMapEntity script = (bl_MiniMapEntity)target;
        ...
        {
            GUILayout.Space(2);
            script.interacableAction = (bl_MiniMapEntity.InteracableAction)EditorGUILayout.EnumPopup("Interactable Action", script.interacableAction, EditorStyles.toolbarDropDown);
            GUILayout.Space(2);
