...
/// </summary>
    ...
    void MapSize()
    {
        ...
        var MiniMapUIRoot = MiniMapUI.root;
        if (isFullScreen)
        {
    ...
    public void SetHoofdPunt()
    {
        ...
        GameObject newItem = Instantiate(HoofdPuntPrefab, new Vector3(0, 0, 100), Quaternion.identity);

        var mmItem = newItem.GetComponent<bl_MiniMapEntityBase>();
        mmItem.SetTarget(newItem.transform);
    }
    ...
    void OnValidate()
    {
        ...
        if (MiniMapUI != null && MiniMapUI.playerIconImage != null)
        {
            MiniMapUI.playerIconImage.sprite = PlayerIconSprite;
            MiniMapUI.playerIconImage.color = playerColor;
        }
    }
#endif
    ...
    public void SetMapRotation(bool dynamic)
    {
        ...
        minimapRig.eulerAngles = new Vector3(0, 0, 0);
    }
